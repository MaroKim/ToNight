...
insert into Club(c_num, d_districtCode, t_themeCode, c_clubName) values(2, 3, 1, 'BONE');
insert into Club(c_num, d_districtCode, t_themeCode, c_clubName) values(3, 3, 1, 'MUTE');
